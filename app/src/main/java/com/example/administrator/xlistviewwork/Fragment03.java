...
public class Fragment03 extends Fragment implements XListView.IXListViewListener{
    private String path1 = "http://api.expoon.com/AppNews/getNewsList/type/3/p/1";
    private String path2 = "http://api.expoon.com/AppNews/getNewsList/type/3/p/2";
    private String path3 = "http://api.expoon.com/AppNews/getNewsList/type/3/p/3";
    private  int a=0;
    private int b=0;
                ...
                try {
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            lv.setXListViewListener(MainActivity.fragment03);
                        }
                    });
